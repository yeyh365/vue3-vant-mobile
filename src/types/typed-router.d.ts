...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'questionnaire': RouteRecordInfo<'questionnaire', '/questionnaire', Record<never, never>, Record<never, never>>,
    'register': RouteRecordInfo<'register', '/register', Record<never, never>, Record<never, never>>,
    'responses': RouteRecordInfo<'responses', '/responses', Record<never, never>, Record<never, never>>,
